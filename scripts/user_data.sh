...
#   ${db_password}   — contraseña del usuario admin de MySQL
...
# ── 4. Generar /app/backend/.env ─────────────────────────────
# Nota: printf '%s=%s\n' es más seguro que echo o heredoc para
...
# ── 5. Instalar dependencias y arrancar con PM2 ───────────────
